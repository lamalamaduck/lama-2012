...
\item
  ...
  \item \hfill \\
    ...
    lausekkeena kielen voi kirjoittaa esimerkiksi $aaa(aaa|aaaa)^*$
    (muodostettu vastaamaan e\-pä\-de\-ter\-mi\-nis\-tis\-tä
    automaattia) tai $(a^3|a^6|a^7|a^9a^*)$ (muodostettu
