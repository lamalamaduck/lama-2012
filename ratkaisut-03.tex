...
\item
  ...
  FIXME: tähän kuvat automaateista, joissa on yksi hyväksyvä tila, sen
  käänteiskielen automaatti ja toinen esimerkki kahden hyväksyvän tilan
  automaatista, jota kääntäessä käy ilmi että tarvitaan ylimääräinen tila
  ennen kuin automaatin voi kääntää.

  Olkoon $M = (Q,\Sigma,\delta,s,F)$ kielen $A$ tunnistava deterministinen
  automaatti. Muodostetaan nyt yllä olevien esimerkkien motivoimana automaatti
  $M^\mathcal{R}$ käänteiskielelle $A^\mathcal{R}$.
