...
\item
  ...
  \item \hfill \\
    ...
    Sanoissa saavat vuorotella ja toistua merkkijono $baa$ ja jokin
    pelkästään $a$:sta koostuva merkkijono. Automaatin määrittelemä
    säännöllinen kieli on siis $(\set{a} \cup \set{baa})^*$ joka
    voidaan kuvata myös säännöllisellä lausekkeella $(a | baa)^*$.
