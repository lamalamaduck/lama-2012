...
\newcolumntype{W}{>{\centering}m{5cm} }
\newcolumntype{V}{>{\centering}m{2cm} }
...
%
        ...
        \end{equation*}
%
        Automaatin tilajoukko on siis karteesinen tulo alkuperäisten
        automaattien tiloista. Kaikki uuden automaatin tilat ovat siis muotoa
        $(q, p)$ missä $q \in Q_A$ ja $p \in Q_B$. Siirtymät noudattavat parin
        ensimmäisen alkion kohdalla automaatin $M_A$ siirtymäfunktiota ja
        toisen alkion kohdalla automaatin $M_B$ siirtymäfunktiota. Pinon
        käsittely noudattaa aina automaatin $M_A$ siirtymäfunktiota, sillä
        automaatissa $M_B$ ei ole pinoa.
%
        \begin{center}
        \begin{tabular}{W V W}
        \begin{automata}
...
%
        ...
        \end{center}
%
        Nyt luotu automaatti $M_{A \cap B}$ hyväksyy merkkijonon $w$ jos ja
        vain jos $M_A$ ja $M_B$ hyväksyvät merkkijonon $w$. Siis $M_{A \cap
          B}$ tunnistaa kielen $A \cap B$.
      \end{proof}
