...
%
  ...
  \item
    ...
    \begin{centerautomata}
      ...
      \node[state]         (q2) [below of=q1] {$q_2$};
      \node[accepting,state] (a) [below of=q2] {$q_{accept}$};

      \path
      (q0) edge [loop above] node {\doubletrans{a,b}{a,b}{R}{\spc}{\#}{R}} (q0)
      (q0) edge              node {\doubletrans{\spc}{\spc}{S}{\spc}{\spc}{S}} (q1)
      (q1) edge [loop left]  node {siirrä nauhan 2 lukupää alkuun} (q1)
      (q1) edge              node {\doubletrans{\spc}{\spc}{L}{\#}{\#}{S}} (q2)
      (q2) edge [loop left]  node {\doubletrans{a}{a}{L}{\#}{a}{R}} (q2)
      (q2) edge [loop right] node {\doubletrans{b}{b}{L}{\#}{b}{R}} (q2)
      (q2) edge              node {\doubletrans{a,b}{a,b}{S}{\spc}{\spc}{S}} (a);
    \end{centerautomata}
