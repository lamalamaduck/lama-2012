...
{$\left[\begin{array}{c}\trans{#1}{#2}{#3}%
      \\ \trans{#4}{#5}{#6}\end{array}\right]$}
  ...
  \item
    ...
    \begin{centerautomata}[4]
      ...
      (q0) edge [loop above,looseness=12]
           node
           {\doubletrans{a,b}{a,b}{R}{\spc}{\#}{R}} (q0)
      (q0) edge
           node
           {\doubletrans{\spc}{\spc}{S}{\spc}{\spc}{S}} (q1)
      (q1) edge
           node
           {siirrä nauhan 2 lukupää alkuun} (q2)
      (q2) edge
           node [swap]
           {\doubletrans{\spc}{\spc}{L}{\#}{\#}{S}} (q3)
      (q3) edge [loop above,looseness=12]
           node
           {\doubletrans{a}{a}{L}{\#}{a}{R}} (q3)
      (q3) edge [loop below,looseness=12]
           node
           {\doubletrans{b}{b}{L}{\#}{b}{R}} (q3)
      (q3) edge [bend left]
           node
           {\begin{tabular}{l}
               \doubletrans{a}{a}{S}{\spc}{\spc}{S} \\
               \doubletrans{b}{b}{S}{\spc}{\spc}{S}
           \end{tabular}} (a);
    \end{centerautomata}
...
%
    \begin{centerautomata}
        ...
        \node[state] (q2) [below right of=start] {$q_2$};
        \node[state,accepting] (accept) [below of=start] {$q_{\text{accept}}$};

        \path
        (start) edge node [swap] {\doubletranss{0,1,\spc \to R}{\spc \to S}} (accept)
        ;
    \end{centerautomata}
  \end{enumerate}
